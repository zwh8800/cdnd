...
系统的核心设计理念是通过统一的状态结构体(State)来管理游戏的所有动态数据，并通过事件驱动的方式实现各组件间的松耦合通信。状态管理不仅涵盖了传统的游戏数据，还包括AI对话历史、世界标志和计数器等高级功能。
...
**章节来源**
- [state.go:44-181](file://internal/game/state.go#L44-L181)
