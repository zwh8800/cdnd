...
- 新增了选项解析器（ParseOptions）的详细说明和实现机制，替代原有的SetOptionsTool工具调用方式
- 增强了游戏引擎中DM响应结构，增加了选项字段的支持
- 完善了UI界面中选项处理和用户交互流程
- 更新了提示词类型与用途，特别强调了选项提供的重要性
...
**章节来源**
- [internal/llm/prompt/templates.go:1-109](file://internal/llm/prompt/templates.go#L1-L109)
...
- [internal/game/engine.go:195-316](file://internal/game/engine.go#L195-L316)
- [internal/tools/registry.go:9-21](file://internal/tools/registry.go#L9-L21)
- [internal/game/state.go:40-40](file://internal/game/state.go#L40-L40)
...
**章节来源**
- [internal/llm/prompt/templates.go:14-109](file://internal/llm/prompt/templates.go#L14-L109)
- [internal/llm/prompt/builder.go:75-272](file://internal/llm/prompt/builder.go#L75-L272)
...
## 结论
提示词系统通过Templates与Builder实现了模板化、可扩展的提示词生成；配合Provider抽象与工具系统，形成了稳定的代理循环。**重大更新**：现在每个DM响应都必须提供选项列表，通过ParseOptions函数直接解析，显著提升了游戏交互体验。建议后续增强令牌计数与上下文窗口管理、完善工具权限与阶段控制、优化选项解析机制，并持续改进提示词模板以提升叙事质量与安全性。
